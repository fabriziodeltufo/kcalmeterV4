...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="snack-pm.php">SnackPM</a>
        </li>
...
<div>
    <h2 class="text-center tit p-2">BREAK TIME ! AFTERNOON SNACK</h2>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <table class="text-center table table-striped table-hover table-condensed table-bordered table-sm">
                    ...
                    <?php lista_alimenti('DD', 'snack-pm.php') ; ?>
                    <!-- DD = mostra lista alimento nel DROPDOWN -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input required value="<?php echo($_GET['gruppo'] ?? '');?>" type="text" name="gruppo"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input required value="<?php echo($_GET['alimento'] ?? '');?>" type="text" name="alimento"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input required value="<?php echo($_GET['calorie'] ?? 0 );?>" type="text" name="calorie"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input required value="<?php echo($_GET['dose_porzione_gr'] ?? 0);?>" type="text"
                        name="dose_porzione_gr" class="form-control">
                </div>
            </div>
