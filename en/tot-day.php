...
<div>
    ...
    <p class='container text-center'>Enter the maximum number of Kcal. (Calories) per day that you consider acceptable
        as the goal to be achieved.</br>
        <b>Hint:</b> Search Google for the number of calories expected for your age and weight.</br>
        <a target="_blank" href="http://www.caloriegiornaliere.com/"><b>CLICK HERE</b></a> for an example of an
        application that helps you determine your calories goal.
    <p>
</div>
...
<div class="container text-center">
    <div class="row d-flex justify-content-center">
        <div class="col-sm-12">
            <p class="text-center bg-secondary ">KCalories <?php mostraOBB(); ?>
            <p>
        </div>
    </div>
</div>
